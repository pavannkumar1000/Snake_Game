...
function changeDirection(dir){
  switch(dir){
    case 'left': if(xVel !== UNIT){ xVel = -UNIT; yVel = 0; } break;
    case 'right': if(xVel !== -UNIT){ xVel = UNIT; yVel = 0; } break;
    case 'up': if(yVel !== UNIT){ xVel = 0; yVel = -UNIT; } break;
    case 'down': if(yVel !== -UNIT){ xVel = 0; yVel = UNIT; } break;
  }
  if(!started){
    started = true;
    nextTick();
